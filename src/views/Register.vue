  ...
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <form
     ...
     class="p-8 flex flex-col bg-light-grey rounded-md shadow-lg">
      ...
      <div class="flex flex-col mb-2">
        <label for="password" class="mb-1 text-sm text-at-light-green">Hasło:</label>
        <input 
          type="password" 
          required 
          class="p-2 text-gray-500 focus:outline-none" 
      ...
      <div class="flex flex-col mb-2">
        <label for="confirmPassword" class="mb-1 text-sm text-at-light-green">Potwierdź hasło:</label>
        <input 
          type="password" 
          required 
          class="p-2 text-gray-500 focus:outline-none" 
...
export default {
  ...
  setup() {
    ...
    const register = async () => {
      ...
      errorMsg.value = "Error: Podane hasła nie są takie same!";
      setTimeout(() => {
        errorMsg.value = null;
      }, 5000);
    };
